Test.describe('isInteger', function() {
  Test.it('should detect an integer', () => {
    Test.assertEquals(isInteger(10), true)
    Test.assertEquals(isInteger(5), true)
  })
  Test.it('should detect a noninteger', () => {
    Test.assertEquals(isInteger(1.2), false)
  })
})
